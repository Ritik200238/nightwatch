...
LENSES: tuple[Lens, ...] = (
    ...
    Lens(
        ...
        says=("weekend", "over the weekend", "saturday", "sunday", "friday night"),
    ),
    Lens(
        "weeknight", "an ordinary weeknight", "the Monday-to-Thursday overnight window",
        lambda f: _col(f, "bucket") == "weeknight",
        says=("weeknight", "overnight", "a normal night", "midweek night"),
    ),
    Lens(
